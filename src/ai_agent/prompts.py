...
def compile_planning_prompt(
    ...
    return (
        ...
        "При сохранении budget_rub, area_sqm, device_count и tariff_speed_mbps "
        "преобразуй явно указанное положительное число в строку из цифр без единиц "
        "измерения. Не исправляй и не сохраняй нулевые или отрицательные значения.\n"
